...
import MinersTech.Crafting.OreRecipes;
...
public class ContainerMacerator extends Container
	{
		...
		public ContainerMacerator(InventoryPlayer par1InventoryPlayer, TileEntityMacerator par2TileEntityFurnace)
		{
			...
			this.addSlotToContainer(new Slot(par2TileEntityFurnace, 1, 56, 35));
			this.addSlotToContainer(new Slot(par2TileEntityFurnace, 2, 8, 56));
			this.addSlotToContainer(new SlotFurnace(par1InventoryPlayer.player, par2TileEntityFurnace, 3, 116, 35));
			int i;
			...
			for (i = 0; i < 3; ++i)
			{
				for (int j = 0; j < 9; ++j)
				{
					this.addSlotToContainer(new Slot(par1InventoryPlayer, j + i * 9 + 9, 8 + j * 18, 82 + i * 18));
				}
			}
