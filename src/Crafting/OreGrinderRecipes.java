...
public class OreGrinderRecipes
{
    ...
    {
        this.addSmelting(Block.oreIron.blockID, new ItemStack(MinersTech.Dusts, 2, 1), 0.2F);
        this.addSmelting(Block.oreGold.blockID, new ItemStack(MinersTech.Dusts, 2, 0), 0.2F);
        this.addSmelting(MinersTech.oreZondo.blockID, new ItemStack(MinersTech.Dusts, 2, 2), 0.2F);
    }
