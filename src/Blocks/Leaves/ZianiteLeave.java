...
public class ZianiteLeave extends BlockLeavesBase implements IShearable
{
    public static final String[] LEAF_TYPES = new String[] {"zondo", "spruce", "birch", "jungle"};
    public static final String[][] field_94396_b = new String[][] {{"leaves_zondo", "leaves_spruce", "leaves_birch", "leaves_jungle"}, {"leaves_zondo_opaque", "leaves_spruce_opaque", "leaves_birch_opaque", "leaves_jungle_opaque"}};
    ...
    public void registerIcons(IconRegister par1IconRegister)
    {
        for (int i = 0; i < field_94396_b.length; ++i)
        {
            ...
            {
                this.iconArray[i][j] = par1IconRegister.registerIcon("minerstech:" + field_94396_b[i][j]);
            }
        }
    }
