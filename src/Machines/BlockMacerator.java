...
public class BlockMacerator extends BlockContainer{
	...
	public void registerIcons(IconRegister iconRegister){
		this.blockIcon = iconRegister.registerIcon(MinersTech.modid + ":" + "macerator_side");
		this.maceratorIconTop = iconRegister.registerIcon(MinersTech.modid + ":" + (this.isActive ? "macerator_front_lit" : "macerator_front_idle"));
	}
	...
	{
		return MinersTech.blockMaceratorIdle.blockID;
	}   
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitX, float hitY, float hitZ) {
		if(!world.isRemote) {
			FMLNetworkHandler.openGui(player, MinersTech.instance, MinersTech.guiIdMacerator, world, x, y, z);
		}
	...
	public static void updateFurnaceBlockState(boolean par0, World par1World, int par2, int par3, int par4)
	{
		...
		if (par0)
		{
			par1World.setBlock(par2, par3, par4, MinersTech.blockMaceratorActive.blockID);
		}
		else
		{
			par1World.setBlock(par2, par3, par4, MinersTech.blockMaceratorIdle.blockID);
		}
